...
public class EngineHelper {
    ...
    private final ConsolePrinter printer = HubzEngine.printer;

     void setAuthorAndBranchNameIfExist() {
    ...
    //to handle revert output
     void handleRevertCommand(String args) {
     ...
     void handleRevertResult(RevertResult result) {
